...
#Replace With Desired Mean Checkout Times (Default = 30 Minutes)
...
ArrivalTimesSorted1 <- ArrivalTimesSorted
...
for (i in 1:(length(ArrivalTimesSorted) - 2)) {
  ...
  WaitingTime <- ArrivalTimesSorted - ArrivalTimesSorted1
...
#Replace With Desired Checkout Time (Default = 30 Minutes)
CheckoutTime <- 30
